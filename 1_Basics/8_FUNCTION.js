...
//revision 2
//Example1 dice roll on get number on set interval
// function dice(){
//   setInterval(() => {
//     let dice_num=Math.floor(Math.random()*6)+1;
//     console.log(` number is ${dice_num}`);
//   }, 1000);
// }
// console.log(dice());
...
function average(a,b,c){
  return `average of three number:${(a+b+c)/3 }`
}
